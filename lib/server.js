...
var MoscaServer = require('mosca').Server;
var Router = require('middist');

module.exports = MoscaServer;

MoscaServer.prototype.lazyrouter = function () {
  if (!this._router) {
    this._router = new Router();
  }
};

MoscaServer.prototype.use = function (path, fn) {
  this.lazyrouter();
  this._router.use(path, fn);
  return this;
};

MoscaServer.prototype._handle = function (path, context, cb) {
  this.lazyrouter();
 ...
 */
MoscaServer.prototype.authenticate = function(client, username, password, callback) {
 ...
 * @param {Function} callback The callback to return the verdict
 */
MoscaServer.prototype.authorizePublish = function (client, topic, payload, callback) {
 ...
 * @param {Function} callback The callback to return the verdict
 */
MoscaServer.prototype.authorizeSubscribe = function (client, topic, callback) {
 ...
 */
MoscaServer.prototype.authorizeForward = function (client, packet, callback) {
  var that = this;
...
MoscaServer.prototype.beforeSubscribe = function (client, packet, cb) {
...
MoscaServer.prototype.beforePublish = function (client, packet, cb) {
...
MoscaServer.prototype.beforeForward = function (client, packet, cb) {
...
MoscaServer.prototype.beforeUnsubscribe = function (client, packet, cb) {
